...
func newEventSource(ctx context.Context, cfg Config, mountInfos []MountInfo) (EventSource, error) {
	...
	optional := []probeSpec{
		...
		{symbol: "ll_xattr_get", program: "ll_getxattr_wrapper_enter", optional: true},
		{symbol: "ll_xattr_get", program: "ll_getxattr_wrapper_exit", ret: true, optional: true},
		{symbol: "ll_xattr_set", program: "ll_setxattr_wrapper_enter", optional: true},
		{symbol: "ll_xattr_set", program: "ll_setxattr_wrapper_exit", ret: true, optional: true},
		...
		{symbol: "ll_get_acl", program: "ll_get_acl_enter", optional: true},
		{symbol: "ll_get_acl", program: "ll_get_acl_exit", ret: true, optional: true},
		...
		{symbol: "ll_set_acl", program: "ll_set_acl_enter", optional: true},
		{symbol: "ll_set_acl", program: "ll_set_acl_exit", ret: true, optional: true},
